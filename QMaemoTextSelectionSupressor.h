...
class QMaemoTextSelectionSupressor : public QObject
{
 Q_OBJECT
public:
 QMaemoTextSelectionSupressor(QWidget *v)
...
bool QMaemoTextSelectionSupressor::eventFilter(QObject *, QEvent *e)
{
 switch (e->type()) {
...
#endif /* QMAEMOTEXTSELECTIONSUPRESSOR_H_ */
